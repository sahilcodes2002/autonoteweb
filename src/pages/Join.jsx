                          ...
                          if (username == "") {
                            ...
                            try {
                              const response = await axios.post(
                                "https://autonotebackend.shadowbites10.workers.dev/varification",
                                {
                                  email: username.trim(),
                                }
                              );
                          ...
                          <button
                            onClick={async () => {
                              if (username == "") {
                                ...
                                try {
                                  const response = await axios.post(
                                    "https://autonotebackend.shadowbites10.workers.dev/varifycode",
                                    {
                                      email: username.trim(),
                        ...
                        <button
                          onClick={async () => {
                            if (
                              ...
                              try {
                                const response = await axios.post(
                                  "https://autonotebackend.shadowbites10.workers.dev/signup",
                                  {
                                    name: firstName,
                                    username,
                                    password,
